...
argglobal
if bufexists(fnamemodify("term://~//8034:nu", ":p")) | buffer term://~//8034:nu | else | edit term://~//8034:nu | endif
if &buftype ==# 'terminal'
  silent file term://~//8034:nu
endif
...
wincmd w
argglobal
if bufexists(fnamemodify("term://~//8154:nu", ":p")) | buffer term://~//8154:nu | else | edit term://~//8154:nu | endif
if &buftype ==# 'terminal'
  silent file term://~//8154:nu
endif
setlocal foldmethod=manual
setlocal foldexpr=0
setlocal foldmarker={{{,}}}
...
wincmd w
argglobal
if bufexists(fnamemodify("term://~//8235:nu", ":p")) | buffer term://~//8235:nu | else | edit term://~//8235:nu | endif
if &buftype ==# 'terminal'
  silent file term://~//8235:nu
endif
setlocal foldmethod=manual
setlocal foldexpr=0
setlocal foldmarker={{{,}}}
...
wincmd w
argglobal
if bufexists(fnamemodify("term://~//8338:nu", ":p")) | buffer term://~//8338:nu | else | edit term://~//8338:nu | endif
if &buftype ==# 'terminal'
  silent file term://~//8338:nu
endif
setlocal foldmethod=manual
setlocal foldexpr=0
setlocal foldmarker={{{,}}}
...
wincmd w
argglobal
if bufexists(fnamemodify("term://~//8115:nu", ":p")) | buffer term://~//8115:nu | else | edit term://~//8115:nu | endif
if &buftype ==# 'terminal'
  silent file term://~//8115:nu
endif
setlocal foldmethod=manual
setlocal foldexpr=0
setlocal foldmarker={{{,}}}
...
wincmd w
argglobal
if bufexists(fnamemodify("term://~//8188:nu", ":p")) | buffer term://~//8188:nu | else | edit term://~//8188:nu | endif
if &buftype ==# 'terminal'
  silent file term://~//8188:nu
endif
setlocal foldmethod=manual
setlocal foldexpr=0
setlocal foldmarker={{{,}}}
...
wincmd w
argglobal
if bufexists(fnamemodify("term://~//8286:nu", ":p")) | buffer term://~//8286:nu | else | edit term://~//8286:nu | endif
if &buftype ==# 'terminal'
  silent file term://~//8286:nu
endif
setlocal foldmethod=manual
setlocal foldexpr=0
setlocal foldmarker={{{,}}}
...
wincmd w
argglobal
if bufexists(fnamemodify("term://~//8372:nu", ":p")) | buffer term://~//8372:nu | else | edit term://~//8372:nu | endif
if &buftype ==# 'terminal'
  silent file term://~//8372:nu
endif
setlocal foldmethod=manual
setlocal foldexpr=0
setlocal foldmarker={{{,}}}
